function [str] = perio_stream3(x,y,z,bx,by,bz,sx,sy,sz)
    ds = 0.01;
    pos = stream3(x,y,z,bx,by,bz,sx,sy,sz,[ds,100000]);
    neg = stream3(x,y,z,-bx,-by,-bz,sx,sy,sz,[ds,100000]);
...
%                count = count + 1
                ...
                if bsz <= z(end) && bsz >= z(1)
                    if (bsx <= x(1))
                        ...
                        %if pos{i}(end,2) >= y(1) && pos{i}(end,2) <= y(end) && pos{i}(end,3) >= z(1) && pos{i}(end,3) <= z(end)
...
%                         if pos{i}(end,1) >= x(1) && pos{i}(end,1) <= x(end) && pos{i}(end,3) >= z(1) && pos{i}(end,3) <= z(end)
...
%                         if neg{i}(end,2) >= y(1) && neg{i}(end,2) <= y(end) && neg{i}(end,3) >= z(1) && neg{i}(end,3) <= z(end)
...
%                        if neg{i}(end,1) >= x(1) && neg{i}(end,1) <= x(end) && neg{i}(end,3) >= z(1) && neg{i}(end,3) <= z(end)
