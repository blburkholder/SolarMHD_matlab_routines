...
ti_tube1 = xend_t0 > 20 & xend_t0 < 60 & yend_t0 > 40 & yend_t0 < 70;
ti_tube2 = yend_t0 > 70;
ti_tube3 =  yend_t0 < 34 | xend_t0 > 80; 

tf_tube1 = xend_open_tf > 20 & xend_open_tf < 60 & yend_open_tf > 40 & yend_open_tf < 70;
tf_tube2 = yend_open_tf > 70;
tf_tube3 = yend_open_tf < 34 | xend_open_tf > 80;
...
flipx = x_fluelt_tf(tubetag1 ~= tubetag2 & tubetag1 > 0);
flipy = y_fluelt_tf(tubetag1 ~= tubetag2 & tubetag1 > 0);
